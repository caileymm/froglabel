...
function BoxFilePanel({ selectedRow, drawingRow, selectedAudio, setSelectedAudio, theme }) {
    ...
    return (
        <div className='flex flex-col gap-2'>
            ...
            <div style={{ backgroundColor: theme.group }} className='flex flex-col flex-1 rounded-lg font-display text-md p-2 gap-1'>
                Box Details
                    ...
                    {[
                        ...
                        <div key={header} className='flex flex-col'>
                            ...
                            <div className='flex flex-row items-center gap-1'>
                                <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{value}</span>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    {audioFiles.map(({ filename, audio }) => (
                        ...
                        >
                            ...
                            <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{filename}</span>
                        </div>
                    ))}
                    <div className='flex flex-col'>
                        <span style={{ color: theme.text }} className='font-display text-sm'>Sample Rate</span>
                        <div className='flex flex-row items-center gap-1'>
                            <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{info?.sampleRate ?? '—'}</span>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-row items-center gap-1'>
                            <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{info?.channels ?? '—'}</span>
                        </div>
                    </div>
                    <div className='flex flex-col'>
                        <span style={{ color: theme.text }} className='font-display text-sm'>Bit Rate</span>
                        <div className='flex flex-row items-center gap-1'>
                            <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{info?.bitrate ?? '—'}</span>
                        </div>
                    </div>
                    <div className='flex flex-col'>
                        <span style={{ color: theme.text }} className='font-display text-sm'>Version</span>
                        <div className='flex flex-row items-center gap-1'>
                            <span style={{ backgroundColor: theme.cream, color: theme.text }} className='rounded-sm px-2 py-0.5 font-display text-sm inline-block self-start'>{info?.version ?? '—'}</span>
                        </div>
                    </div>
                </div>
            </div>
