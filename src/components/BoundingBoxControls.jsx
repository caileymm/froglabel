  ...
  return (
    <div className='p-2 bg-[#82A062] rounded-xl flex items-center justify-center gap-2'>
      <div className='p-2 bg-[#C8D9A3] rounded-xl flex items-center gap-1'>
        ...
        <input placeholder='Species Name' className='w-36 px-2 py-1.5 text-sm bg-[#FFFFFF] rounded-md font-display placeholder-[#E6E5C9]'/>
        <button className='px-2 py-1.5 text-sm bg-[#FEECBE] rounded-md font-display whitespace-nowrap hover:bg-[#FFDE9E] cursor-pointer'>
          Start Labeling
        </button>
      </div>
      <div className='p-2 bg-[#C8D9A3] rounded-xl flex items-center gap-1'>
